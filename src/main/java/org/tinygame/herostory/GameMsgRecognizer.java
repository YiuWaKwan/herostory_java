...
public final class GameMsgRecognizer {
     ...
     * 消息代码和消息体字典
     */
    static private final Map<Integer, GeneratedMessage> _msgCodeAndMsgBodyMap = new HashMap<>();
    ...
    static public Message.Builder getMsgBuilderByMsgCode(int msgCode) {
        ...
        // 获取消息对象
        GeneratedMessage msg = _msgCodeAndMsgBodyMap.get(msgCode);
        if (null == msg) {
            return null;
        }
